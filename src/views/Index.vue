...
&  Asia market. 
      ...
      <img
        class="absolute top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-10/12 max-h-860-px" style="padding-top: 5rem;"
        :src="patternVue"
        alt="..."
      />
    </section>
...
Our System Integration services ensure that all your IT assets — whether legacy systems, cloud applications, or third-party solutions</p>
      ...
      <div id="Servicess" class="container mx-auto overflow-hidden pb-20">
        <div class="flex flex-wrap items-center">
...
By earning trust, delivering only the best, and nurturing long-lasting relationships, we aspire to make technology a force for progress and help shape a better, more connected world.
            </p>
                ...
                >
                  ...
                  >
                    <img
                      alt="..."
                      class="shadow-md rounded-full max-w-full w-16 mx-auto p-2 bg-white"
                      src="@/assets/img/consumer-centric.png"
                    />
                    <p class="text-lg text-white mt-4 font-semibold">
...
<div class="w-full md:w-6/12 px-12 md:px-4">             
<h2 class="font-semibold text-4xl" style="
    color: white;
    text-align: center;
">Global Presence</h2><p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500" style="
    text-align: center;
    color: white;
"> We have successfully delivered projects across Europe, and Asia, demonstrating our ability to adapt to diverse markets and regulatory environments. </p></div>
...
import patternVue from "@/assets/img/R.png";
