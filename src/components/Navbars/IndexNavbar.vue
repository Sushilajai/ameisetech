<template>
  <div>
    ...
    <!-- Navbar -->
    <nav
      class="top-0 fixed z-600 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-white shadow"
    >
